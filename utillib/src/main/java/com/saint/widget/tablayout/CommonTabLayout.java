...
import com.saint.widget.tablayout.listener.CustomTabEntity;
import com.saint.widget.tablayout.listener.OnTabSelectListener;
import com.saint.widget.tablayout.utils.FragmentChangeManager;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextSelectSize = ta.getDimension(R.styleable.CommonTabLayout_tl_textSelectSize, sp2px(14f));
