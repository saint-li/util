 ...
 */
public class SlidingNoViewPagerTabLayout extends HorizontalScrollView {
    ...
    public SlidingNoViewPagerTabLayout(Context context) {
        this(context, null, 0);
    }

    public SlidingNoViewPagerTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingNoViewPagerTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        CharSequence pageTitle = mTitles.get(mTabCount);
        addTab(mTabCount, title, tabView);
        this.mTabCount = mTitles.size();
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                tv_tab_title.setPadding((int) mTabPaddingLeft, (int) mTabPaddingBottom
                        , (int) mTabPaddingRight, (int) mTabPaddingBottom);
                if (mTextAllCaps) {
...
//    }
    ...
    public void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            ...
            lp.leftMargin = mTabWidth >= 0 ? (int) (mTabWidth / 2 + textWidth / 2 + dp2px(leftPadding)) : (int) (mTabPaddingTop + textWidth + dp2px(leftPadding));
