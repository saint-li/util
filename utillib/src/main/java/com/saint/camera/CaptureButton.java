...
import com.saint.camera.util.CheckPermission;
import com.saint.util.util.AppLog;

import static com.saint.camera.JCameraView.BUTTON_STATE_BOTH;
import static com.saint.camera.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.saint.camera.JCameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View {
    ...
    public CaptureButton(Context context, int size) {
        ...
        AppLog.i("CaptureButtom start");
        duration = 10 * 1000;              //默认最长录制时间为10s
        AppLog.i("CaptureButtom end");
