package com.saint.camera.state;

import android.graphics.Bitmap;
import android.view.Surface;
import android.view.SurfaceHolder;

import com.saint.camera.CameraInterface;
import com.saint.camera.JCameraView;
...
class PreviewState implements State {
    ...
    public void cancle(SurfaceHolder holder, float screenProp) {
        AppLog.i("浏览状态下,没有 cancle 事件");
    }

    @Override
    public void confirm() {
        AppLog.i("浏览状态下,没有 confirm 事件");
    }
