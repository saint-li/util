...
import com.saint.camera.listener.JCameraListener;
...
//    private static final String TAG = "JCameraView";
    ...
    private long videoDuration = 0;       //录制后视频时间
...
//        });
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        AppLog.i("JCameraView SurfaceCreated");
        new Thread() {
            @Override
            public void run() {
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        AppLog.i("JCameraView SurfaceDestroyed");
    ...
    public void confirmState(int type) {
        switch (type) {
            case TYPE_VIDEO:
                ...
                machine.start(mVideoView.getHolder(), screenProp);
                if (jCameraLisenter != null) {
                    jCameraLisenter.recordSuccess(videoUrl, videoDuration, firstFrame);
                }
                break;
            case TYPE_PICTURE:
                mPhoto.setVisibility(INVISIBLE);
